...
//         //check code output success or not
//         if(result.success){
...
//                     <PanelResizeHandle className="bg-base-300 w-2 hover:bg-primary transition-colors cursor-col-resize"/>
...
//                         </Panel>
//                          <PanelResizeHandle className="bg-base-300 h-2 hover:bg-primary transition-colors cursor-row-resize"/>
